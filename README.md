...
- Funcionalidades
- Visualização 3D dos planetas
- Rotação interativa com o mouse
- Sistema de zoom suave (scroll)
- Transição animada ao selecionar planetas
- Exibição de informações com efeito de digitação
- Carrossel automático com pausa ao passar o mouse
...
- Praticar renderização 3D na web
- Trabalhar manipulação de modelos .glb
- Criar interações fluidas e responsivas
- Desenvolver um projeto visual para portfólio
